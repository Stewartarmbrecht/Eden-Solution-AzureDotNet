namespace MyEdenSolution.Audio.Tests.E2E
{
    using System;
    ...
    public class CategoriesApiTests
    {
        ...
        public async Task AddCategoryWithSuccess()
        {
            ...
            MyEdenSolution.Categories.Services.Models.Response.CategoryDetails newCategory =
            ...
            var count = 0;
            MyEdenSolution.Categories.Services.Models.Response.CategoryDetails category = null;
            while (count < 5)
            {
