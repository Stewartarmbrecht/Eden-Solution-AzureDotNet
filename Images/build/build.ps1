...
Set-Location "$directoryStart/src/MyEdenSolution.$microserviceName/MyEdenSolution.$microserviceName.Api"
$results = ExecuteCommand "dotnet publish -c Release -o $directoryStart/.dist/api" $loggingPrefix "Publishing the api application."

Set-Location "$directoryStart/src/MyEdenSolution.$microserviceName/MyEdenSolution.$microserviceName.WorkerApi"
...
$apiDestination = "$directoryStart/deploy/MyEdenSolution.$microserviceName.Api.zip"
...
$workerDestination = "$directoryStart/deploy/MyEdenSolution.$microserviceName.WorkerApi.zip"
