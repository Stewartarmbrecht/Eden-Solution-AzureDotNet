...
using MyEdenSolution.Images.Services;
using MyEdenSolution.Images.Services.Models.Results;
...
using MyEdenSolution.Common.BlobRepository;
using System.IO;
using System.Net.Http;
using MyEdenSolution.Images.Services.Converters;
using MyEdenSolution.Images.Services.Models.Requests;
using MyEdenSolution.Common.UserAuthentication;
using Newtonsoft.Json;

namespace MyEdenSolution.Images.Api
{
