...
$webApiJob = Start-Job -Name "rt-ImagesApi" -ScriptBlock {
    ...
    $location = "../src/MyEdenSolution.Images/MyEdenSolution.Images.API"
...
$webWorkerJob = Start-Job -Name "rt-ImagesWorker" -ScriptBlock {
    ...
    $location = "../src/MyEdenSolution.Images/MyEdenSolution.Images.WorkerApi"
...
$apiTestJob = Start-Job -Name "rt-ImagesTestE2E" -ScriptBlock {
    ...
    $location = "../src/MyEdenSolution.Images/MyEdenSolution.Images.Tests.E2E"
