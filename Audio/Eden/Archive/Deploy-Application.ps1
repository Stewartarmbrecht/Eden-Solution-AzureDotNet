...
$loggingPrefix = "MyEdenSolution Audio Deploy Apps $instanceName"

Write-EdenInfo "Deploying the applications." $loggingPrefix
...
Write-EdenInfo "Finished deploying the applications." $loggingPrefix
