...
try {
    Write-EdenInfo "Calling service health check at 'https://$($Settings.EnvironmentName)-audio.azurewebsites.net/api/healthcheck?userId=developer98765@test.com'." $LoggingPrefix
