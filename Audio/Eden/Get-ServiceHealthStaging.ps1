...
try {
    Write-EdenBuildInfo "Calling service health check at 'https://$($Settings.EnvironmentName)-audio-staging.azurewebsites.net/api/healthcheck?userId=developer98765@test.com'." $LoggingPrefix
