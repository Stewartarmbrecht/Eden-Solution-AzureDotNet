...
$loggingPrefix = "MyEdenSolution Api Deploy Infrastructure $instanceName "
...
Write-EdenInfo "Deploying the api." $loggingPrefix
...
Write-EdenInfo "Deployed the api infrastructure." $loggingPrefix
